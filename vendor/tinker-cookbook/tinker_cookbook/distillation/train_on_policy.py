...
async def do_train_step_and_get_sampling_client(
    ...
    sampling_client, _sampling_ref, full_batch_metrics = await compute_full_batch_metrics_and_get_sampling_client(
        cfg,
        training_client,
...
async def do_sync_training(
    ...
    sampling_client, _sampling_ref, _ = await save_checkpoint_and_get_sampling_client(
        cfg,
        training_client,
        start_batch,
        cfg.log_path,
