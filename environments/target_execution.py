...
from data_generator import build_target_execution_dataset


def build_rubric() -> vf.Rubric:
    rubric = vf.Rubric(
        funcs=[
            backend.transition_target_without_press_metric,
...
def load_environment(
    ...
    **kwargs: Any,
    ...
    dataset = build_target_execution_dataset(num_sessions=num_train_examples, seed=seed)
    rubric = build_rubric()
